    ...
    <style>
        ...
        *
        ...
        .about-us-section {
            ...
            background: linear-gradient(rgba(150, 0, 128, 0.5), rgba(160, 0, 128, 0.5)), url('images/pp.jpg');
...
<section class="events-container">
    <h2>About Dua International School</h2>
    <p>Dua International School is a vibrant and nurturing environment specifically designed for students. With a strong focus on early childhood education, including primary, middle, and higher education, the school provides a range of stimulating and engaging activities that promote learning and development in a fun and supportive atmosphere.</p>
    <p>Our goal is to create an inclusive and nurturing learning environment where each student can explore their full potential. From the colorful and interactive classrooms to the spacious outdoor play area, every aspect of Spica International School has been thoughtfully designed to meet the unique needs of all learners. Our highly trained and experienced teachers provide individualized attention to each child, fostering a love of learning that stays with them throughout their lives.</p>
