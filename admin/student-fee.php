                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <th><?php echo ++$key ?></th>
                                    <th <?php echo $highlight ?>><?php echo ucwords($value) ?></th>
                                    <th></th>
                                    <th>
                                        ...
                                        <a href="?action=pay&month=<?php echo $value ?>&std_id=<?php echo $std_id ?>" class="btn btn-sm btn-dark"><i class="fa fa-envelope fa-fw"></i>Send Now</a>
                ...
                <tbody>
                    ...
                    foreach ($students as $key => $student) { ?>
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <a href="?action=view&std_id=<?php echo $student->id ?>" class="btn btn-xs btn-info"><i class="fa fa-eye fa-fw"></i> View</a>
